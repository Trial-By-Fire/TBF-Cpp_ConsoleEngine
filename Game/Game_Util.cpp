...
void Character_Update(Character* _character, Level* _level)
{
	...
	{
		Renderer_WriteToLog((WideChar*)L"Giving character jump velocity");
...
void Character_Render(Character* _character)
{
	...
	Renderer_WriteToPersistentSection(1, (WideChar*)L"Pos X: %f", _character->Position.X);
	Renderer_WriteToPersistentSection(3, (WideChar*)L"Pos Y: %f", _character->Position.Y);

	Renderer_WriteToPersistentSection(2, (WideChar*)L"RC  X: %u", renderCoord.X);
	Renderer_WriteToPersistentSection(4, (WideChar*)L"RC  Y: %u", renderCoord.Y);
